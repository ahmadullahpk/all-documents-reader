 ...
 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFWorkbook#createCellStyle()
 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFWorkbook#getCellStyleAt(short)
 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(com.ahmadullahpk.alldocumentreader.xs.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFPalette#getColor(short)
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == com.ahmadullahpk.alldocumentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (com.ahmadullahpk.alldocumentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(com.ahmadullahpk.alldocumentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == com.ahmadullahpk.alldocumentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != com.ahmadullahpk.alldocumentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(com.ahmadullahpk.alldocumentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
