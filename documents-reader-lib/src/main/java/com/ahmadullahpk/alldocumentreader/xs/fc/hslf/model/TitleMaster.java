...
public final class TitleMaster extends MasterSheet
{
     ...
     *
     */
    public TitleMaster(com.ahmadullahpk.alldocumentreader.xs.fc.hslf.record.Slide record, int sheetNo)
    {
    ...
    public MasterSheet getMasterSheet()
    {
        ...
        SlideAtom sa = ((com.ahmadullahpk.alldocumentreader.xs.fc.hslf.record.Slide)getSheetContainer()).getSlideAtom();
