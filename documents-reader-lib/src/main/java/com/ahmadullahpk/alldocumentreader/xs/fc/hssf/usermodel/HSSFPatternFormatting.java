 ...
 *
 */
public class HSSFPatternFormatting implements com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.PatternFormatting
{
	...
	/**
	 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.cf.PatternFormatting#getFillBackgroundColor()
	 */
	...
	/**
	 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.cf.PatternFormatting#getFillForegroundColor()
	 */
	...
	/**
	 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.cf.PatternFormatting#getFillPattern()
	 */
	...
	/**
	 * @param bg
	 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.cf.PatternFormatting#setFillBackgroundColor(int)
	 */
	...
	/**
	 * @param fg
	 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.cf.PatternFormatting#setFillForegroundColor(int)
	 */
	...
	/**
	 * @param fp
	 * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.cf.PatternFormatting#setFillPattern(int)
	 */
