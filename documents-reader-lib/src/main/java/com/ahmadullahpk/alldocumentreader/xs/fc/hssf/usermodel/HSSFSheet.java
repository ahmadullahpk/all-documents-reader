...
import com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.AutoFilterInfoRecord;
import com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.CellValueRecordInterface;
import com.ahmadullahpk.alldocumentreader.xs.fc.hssf.record.DVRecord;
...
import com.ahmadullahpk.alldocumentreader.xs.fc.hssf.util.Region;
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.SpreadsheetVersion;
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.CellRange;
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.DataValidation;
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.DataValidationHelper;
...
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.util.SSCellRange;
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.Sheet
{
     ...
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
     ...
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFRow
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(com.ahmadullahpk.alldocumentreader.xs.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.com.wxiwei.office.fc.ss.usermodel.FormulaEvaluator} is the
     ...
     *  {@link com.ahmadullahpk.alldocumentreader.xs.ss.model.baseModel.com.wxiwei.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)}
     ...
     *
     * @see com.ahmadullahpk.alldocumentreader.xs.ss.model.baseModel.com.wxiwei.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)
     */
