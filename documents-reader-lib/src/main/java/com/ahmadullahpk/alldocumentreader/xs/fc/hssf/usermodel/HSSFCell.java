...
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.Comment;
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.FormulaError;
...
import com.ahmadullahpk.alldocumentreader.xs.fc.ss.usermodel.IHyperlink;
...
public class HSSFCell implements ICell {
     ...
     *
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFRow#createCell(short)
     */
     ...
     *                Type of cell
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFRow#createCell(short,int)
     */
...
//        agg.setParsedExpression(ptgs);
     ...
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFSheet#removeRow(org.apache.poi.ss.usermodel.Row)
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFSheet#shiftRows(int, int, int)
     * @see com.ahmadullahpk.alldocumentreader.xs.fc.hssf.usermodel.HSSFSheet#addMergedRegion(com.wxiwei.office.fc.ss.util.HSSFCellRangeAddress)
